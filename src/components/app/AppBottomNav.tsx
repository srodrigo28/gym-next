...
export function AppBottomNav({ active, onSignOut }: AppBottomNavProps) {
  ...
  return (
    <nav className="absolute inset-x-0 bottom-0 z-30 flex h-16 items-center justify-around bg-[#202024]" style={{ paddingBottom: "max(4px, env(safe-area-inset-bottom))" }}>
      ...
      <button aria-label="Sair da conta" className="flex h-11 w-14 items-center justify-center text-[#F75A68]" onClick={onSignOut} type="button">
